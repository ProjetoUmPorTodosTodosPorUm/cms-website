...
const pt_BR_shared = {
	...
	remove: {
		...
		'offeror-families':
			'Você deseja remover a família ofertante representada pelo(a) {representative:string}?',
		'welcomed-families':
			'Você deseja remover a família acolhida representada pelo(a) {representative:string}?',
