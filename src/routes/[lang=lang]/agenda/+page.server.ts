...
export const load: PageServerLoad = async ({ fetch, cookies, url, depends }) => {
    ...
    return await listLoad('agenda', fetch, cookies, url)
}

export const actions = {
    remove: async ({ fetch, request, cookies }) => {
        return await removeAction('agenda', fetch, request, cookies)
    },

    restore: async ({ fetch, request, cookies }) => {
        return await restoreAction('agenda', fetch, request, cookies)
    },

    hardRemove: async ({ fetch, request, cookies }) => {
        return await hardRemoveAction('agenda', fetch, request, cookies)
    }
} satisfies Actions
