...
export const load: PageServerLoad = async ({ fetch, cookies, url, depends }) => {
    ...
    return await listLoad('collaborator', fetch, cookies, url)
}

export const actions = {
    remove: async ({ fetch, request, cookies }) => {
        return await removeAction('collaborator', fetch, request, cookies)
    },

    restore: async ({ fetch, request, cookies }) => {
        return await restoreAction('collaborator', fetch, request, cookies)
    },

    hardRemove: async ({ fetch, request, cookies }) => {
        return await hardRemoveAction('collaborator', fetch, request, cookies)
    }
} satisfies Actions
