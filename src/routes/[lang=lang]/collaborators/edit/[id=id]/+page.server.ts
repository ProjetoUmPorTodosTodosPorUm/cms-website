...
import { generateMessages, safeFetch, actionErrorHandler, editLoad, fileRemoveAction, fileAction } from '$utils'
...
export const actions = {
    put: async ({ fetch, request, locals, cookies, params }) => {
        ...
        try {
            schema.validateSync({ title, description, image: image || undefined, field }, { abortEarly: false })
